# -*- coding: utf-8 -*-
"""
Created on Mon Jul 26 22:45:43 2021
...
def parse_datetime():
    return datetime.datetime.strptime(ts[:-7],'%Y-%m-%dT%H:%M:%S.%f')
...
class FtxClient:
    ...
    def __init__(self, api_key=None, api_secret=None, subaccount_name=None) -> None:
        ...
        self._api_key = 'TCJ_4ZUQv782L2eh4yQJ5Pp3pQujT8yAJvSsi2RC'
        self._api_secret = 'Pt2pFNNiz48aWPv1bU_0Uy6-FgJCndrEkOTMBth4'
